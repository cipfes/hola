...
# ─────────────────────────────────────────────
# PARTE F — Guardar la configuración
# ─────────────────────────────────────────────
output = sshCli.send_command("write memory")
print("\n[write memory]\n", output)

# Alternativa equivalente (también aceptada por la guía):
# output = sshCli.send_command("copy running-config startup-config")
